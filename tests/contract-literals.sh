...
pattern='"(input/ready|input/writing|processing|output|failed|images|audio|prompt\.txt|type\.txt|result\.txt|error\.txt|embedding\.json|transcript\.txt|audio\.wav|meta\.json|\.nrvnad\.(pid|lock|ready|info|start))"'
